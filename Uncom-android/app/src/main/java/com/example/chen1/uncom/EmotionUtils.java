...
public class EmotionUtils {
    ...
    private static final int  EMOTION_CLASSIC_TYPE=0x0001;//经典表情
    private static ArrayMap<String,Integer> EMTPY_CUSTOM_MAP_1;
    private static ArrayMap<String,Integer>EMOTION_CLASSIC_MAP;
    public static HashMap<Integer,ArrayMap<String,Integer>> EMPTION_SET;
    static {
        EMPTION_SET=new HashMap<>();
     ...
     * @return
     */
    public static int getImageByName(int EmotionType,String ImageName){
        Integer integer=null;
        switch (EmotionType){
            case  EMOTION_CLASSIC_TYPE:
                integer = EMOTION_CLASSIC_MAP.get(ImageName);
                break;
            default:
                break;
        }
