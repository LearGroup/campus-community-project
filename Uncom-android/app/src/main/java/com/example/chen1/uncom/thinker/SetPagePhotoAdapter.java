...
/**
 * Created by chen1 on 2017/12/31.
 */

public class SetPagePhotoAdapter extends RecyclerView.Adapter<SetPagePhotoAdapter.ViewHolder> implements View.OnClickListener{
    private Bitmap bm;
    private LayoutInflater layoutInflater;
    private Context context;
    private ArrayList<ArrayList<String >> imageUrlList;
    private AsynLoadImageUtils asynLoadImageUtils;
    public ThinkerBean bean;
    public int position;
    private Fragment fragment;
    private SetPageMainFragmentAdapter.OnItemClickListener onItemClickListener;

    public SetPagePhotoAdapter(ArrayList<ArrayList<String>>imageUrlList,ThinkerBean bean,int position,Fragment fragment){
        this.bean=bean;
        this.position=position;
        this.imageUrlList=imageUrlList;
        this.fragment=fragment;
    }
    public void setOnItemClickListener(SetPageMainFragmentAdapter.OnItemClickListener onItemClickListener){
    ...
    private int parseHeight(String path,float currentWidth){
        ...
        if(height*proportion>(DisplayUtils.getWindowHeight(context)*0.6)){
            return (int) (DisplayUtils.getWindowHeight(context)*0.6);
        }else{
