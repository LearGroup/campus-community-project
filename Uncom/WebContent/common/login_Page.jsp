		...
		<div class="col-xs-10 col-sm-8 col-sm-offset-2 col-md-offset-4 col-md-4">
			<div class="login_box col-xs-12">
				...
				<div class="row sigin_content" style="padding-top: 5%;">
					...
					<div class="form-group-sm " id="login_input_username_div">
					...
					<div class="form-group-sm "id="login_input_password_div">
						<div class="col-xs-12 col-lg-8 col-lg-offset-2">
						<span style="left: 5%;" class="glyphicon glyphicon-lock form-control-feedback form-group-lg form-group-sm"></span>
            			<input class="form-control " style="padding-left:10%" type="text" formaction="login_checking.jsp" name="login_password" class="form-control" id="login_input_password" placeholder=" 密码" />
            		</div>
					</div>
